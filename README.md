...
Para usar o deepsleep seria necessário adicionar um botão a placa para controlar quando esse modo seria ligado e desligado, contudo faltou tempo para adicionar o botão e os componentes já estavam colados, o que dificulta a adição do botão. 
